        ...
        <DelayedFadeIn>
          <div className="flex justify-center">
            <Link href={"/#Contact"} passHref>
              <button className="absolute p-2 -mt-5 text-base font-normal text-white bg-orange-600 border-2 border-orange-600 shadow-lg cursor-pointer hover:border-orange-400 shadow-neutral-700 w-36 lg:p-3 lg:w-48 lg:text-xl hover:bg-orange-400">
                Order Now
              </button>
            </Link>
          </div>
